...
fun AccountContribution(
    ...
    Row(
        ...
        ImageThumbnail(Modifier.size(55.dp), imageUrl = saving.userPhoto)
        ...
        Column {
            Row(
                ...
                Text(style = MaterialTheme.typography.bodyMedium, text = saving.username)
